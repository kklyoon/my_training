...
- [ ] [ABC: 항상 코딩 하라](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4) / [번역본](translation/Always_Be_Coding.md)
- [ ] [화이트 보드 쓰기](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1) / [번역본](translation/Whiteboarding.md)
- [ ] [코딩 인터뷰에서 화이트 보드 효율적으로 쓰기](http://www.coderust.com/blog/2014/04/10/effective-whiteboarding-during-programming-interviews/)
- 한쪽 구석을 요구사항, 예시 등 메모하는 공간으로 사용
- 글씨 깔끔하게 쓰기
- 글씨 작게 쓰기, 공간활용하기, 15~20줄 코드가 될 것을 예상하기, 수정의 여지는 남겨두기 (null check, 사소한 조건 등)
- 화이트보드에서 미리 연습해보기
...
- [ ] 특징: 각 정렬이 In place 인가? stable 인가? 각 정렬의 특징
    - Complexity 의 경우 검색, 삽입, 삭제 등에 걸리는 complexity 의 worst case 등  
...
- ### NP, NP-Complete and Approximation Algorithms
    - traveling salesman 와 knapsack problem 와 같은 유명한 NP-complete 문제들을 알고 있어야 한다. 그리고 면접때 면접관이 물어보면 이러한 문제를 알아볼 수 있어야 한다.        
    - NP-complete의 의미를 알고 있어야 한다.
...
원본 : https://github.com/jwasham/coding-interview-university/blob/master/translations/README-ko.md
